		...
		en: {
			translation: {
				...
				unit_details: {
					...
					linkUnitTicketsSnow: 'Link to unit accident',
				...
				hazards: {
					...
					LeadArsenicSelenium: 'Lead-Arsenic-Selenium',
				...
				assessment: {
					...
					other: 'Other subject',
					deleteAssConfirmationMessageTitle: 'Are you sure you want to delete this assessment : ',
					deleteAssConfirmationMessageDescription: 'All relationships with holders, rooms and tickets will be deleted.',
		...
		fr: {
			translation: {
				...
				unit_details: {
					...
					linkUnitTicketsSnow: 'Lien vers les accidents de l\'unité',
				...
				hazards: {
					...
					LeadArsenicSelenium: 'Plomb-arsenic-sélénium',
					Noise: 'Bruit',
				...
				assessment: {
					...
					created: 'Période',
					modifyAssessment: 'Modifier l\'analyse',
					addAssessment: 'Ajouter une nouvelle analyse',
					description: 'Exigences',
					conclusion: 'Conclusion/Commentaires',
					other: 'Autre sujet',
					deleteAssConfirmationMessageTitle: 'Êtes-vous sûrs de vouloir supprimer cette analyse : ',
					deleteAssConfirmationMessageDescription: 'Toutes les rélations avec les responsables, les locaux et les tickets seront aussi supprimées.',
					confirmationMessage: 'Êtes-vous sûrs de vouloir sauvegarder cette analyse?',
